...
public class UDPClientFrame extends javax.swing.JFrame {
    ...
    class UDPClientConnection {
        ...
        public static Object sendRequest(Object... objects) {
            try {
                // Tạo DatagramSocket
                DatagramSocket socket = new DatagramSocket();

                // Chuyển đổi các đối tượng thành byte array
                ByteArrayOutputStream baos = new ByteArrayOutputStream();
                ObjectOutputStream oos = new ObjectOutputStream(baos);

                // Ghi các đối tượng vào luồng
                ...
                // Chuyển đổi phản hồi thành đối tượng
    ...
    class AddAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                // Sử dụng UDP Client Connection
                String response = (String) UDPClientConnection.sendRequest("ADD", student);

                JOptionPane.showMessageDialog(UDPClientFrame.this, response);

                refreshTable();

            } catch (Exception ex) {
                ex.printStackTrace();
                JOptionPane.showMessageDialog(UDPClientFrame.this, "Error adding student.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    class ListAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                ex.printStackTrace();
                JOptionPane.showMessageDialog(UDPClientFrame.this, "Error fetching students.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
...
//    }
    class EditAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (!isUpdateMode) {
                ...
                String studentCode = JOptionPane.showInputDialog(UDPClientFrame.this, "Nhập mã sinh viên cần sửa:");
                if (studentCode == null || studentCode.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(UDPClientFrame.this, "Mã sinh viên không được để trống!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                try {
                    ...
                    if (response instanceof Student) {
                        ...
                        JOptionPane.showMessageDialog(UDPClientFrame.this, "Sinh viên không tồn tại!", "Thông báo", JOptionPane.ERROR_MESSAGE);
                    }
                    ...
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(UDPClientFrame.this, "Lỗi khi tìm kiếm sinh viên!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                // Bước 2: Xử lý khi nhấn "Cập nhật"
                int confirm = JOptionPane.showConfirmDialog(UDPClientFrame.this, "Bạn có muốn cập nhật thay đổi?", "Xác nhận", JOptionPane.YES_NO_OPTION);
                if (confirm == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        ex.printStackTrace();
                        JOptionPane.showMessageDialog(UDPClientFrame.this, "Lỗi khi cập nhật sinh viên!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                    }
                } else {
    ...
    class DeleteAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                int selectedRow = resultTable.getSelectedRow();
                if (selectedRow < 0) {
                    JOptionPane.showMessageDialog(UDPClientFrame.this, "Please select a row to delete.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                int confirm = JOptionPane.showConfirmDialog(UDPClientFrame.this, "Are you sure you want to delete this student?", "Confirm Delete", JOptionPane.YES_NO_OPTION);
                ...
                ex.printStackTrace();
                JOptionPane.showMessageDialog(UDPClientFrame.this, "Error deleting student.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    class SearchAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                String studentCode = JOptionPane.showInputDialog(UDPClientFrame.this, "Enter Student Code to Search:");
                if (studentCode == null || studentCode.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(UDPClientFrame.this, "Student Code cannot be empty.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (response instanceof Student) {
                    ...
                    JOptionPane.showMessageDialog(UDPClientFrame.this, "Student not found.", "Error", JOptionPane.ERROR_MESSAGE);
                }
                ...
                ex.printStackTrace();
                JOptionPane.showMessageDialog(UDPClientFrame.this, "Error searching for student.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    class ExitAction implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            int confirm = JOptionPane.showConfirmDialog(UDPClientFrame.this, "Are you sure you want to exit the program?", "Confirm Exit", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UDPClientFrame.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UDPClientFrame().setVisible(true);
            }
        });
    }
